...
db.products.find({product_price: {$nin:[400,600]}}).pretty();

//4.List the four product which are greater than 500 in price 
db.products.find({product_price: {$gt:500}}).pretty().limit(4);
...
db.products.findOne({ $and:[{product_price:"492"},{product_color:"indigo"}]});

//10.Delete the products which product price value are same
db.products.deleteMany({"product_price":"product_price"}).pretty();